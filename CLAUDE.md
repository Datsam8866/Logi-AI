...
- **結束工作**：對 Claude 說「**收工**」→ 自動 commit + push，並同步更新以下兩份文件：
  1. `<子資料夾>/README.md`：更新「最後更新」日期、新增最新進度區塊、更新 Next Action
  2. `Obsidian/<資料夾名稱>工作筆記.md`：更新「上次做到哪」（含 commit hash）、目前狀態、最近更動紀錄
